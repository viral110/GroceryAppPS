  ...
  class CategoryController extends GetxController {
    ...
    Future<void> addCategory() async {
      if (nameController.text.trim().isEmpty) {
        CommonToast.show("Enter category name",
            type: ToastType.warning);
        return;
      }

      if (imageBytes.value == null) {
        CommonToast.show("Please select category image",
            type: ToastType.warning);
        return;
      }
      ...
      try {
        ...
        final imageUrl = await _uploadImage(bytes: imageBytes.value, path: 'categories/category_${DateTime.now().millisecondsSinceEpoch}_${imageName.value}');
        ...
        CommonToast.show("Category added successfully",
    ...
    Future<void> updateCategory() async {
      ...
      try {
        ...
        CommonToast.show("Category updated",
            type: ToastType.success);
      } catch (e) {
        CommonToast.show(e.toString(), type: ToastType.error);
      } finally {
    ...
    Future<void> deleteCategory(String id, String imageUrl) async {
      try {
        ...
        CommonToast.show("Category deleted",
            type: ToastType.success);
      } catch (e) {
        CommonToast.show(e.toString(), type: ToastType.error);
      }
